...
using OpenDTDC.Simulator;
using OpenDTDC.RunCore;
using Orts.Common;
...
namespace Orts
{
    ...
    static class Program
    {
        ...
        // 初始化 OpenDTDC 模拟器兼容层列车管理器实例
        public static TrainManager TrainManager = new TrainManager();

        // 初始化 OpenDTDC 运行核心
        public static RunCoreInstance OpenDTDCRunCore = new RunCoreInstance(TrainManager);
